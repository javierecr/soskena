...
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(['exports'], t)
    : t(
        ((e = 'undefined' != typeof globalThis ? globalThis : e || self).Sqrl =
          {})
      );
})(this, function (e) {
  'use strict';
  ...
  function F(e, n, r, a) {
    if (n && n.length > 0)
      throw t((a ? 'Native' : '') + "Helper '" + e + "' doesn't accept blocks");
    if (r && r.length > 0)
      throw t(
  ...
  var S = new b({
      ...
      useScope: function (e, t) {
        return F('useScope', t, !1), e.exec(e.params[0]);
      },
    }),
    I = new b({
      if: function (e, t) {
  ...
  var E = new b({
    ...
    j = {
      ...
      async: !1,
      storage: { helpers: S, nativeHelpers: I, filters: E, templates: w },
    ...
    return (
      ...
      (n.dragMove = function (t, e, i) {
        if (this.isDraggable) {
          ...
          this.dragX !== s && (this.previousDragX = this.dragX),
            (this.dragX = s),
...
!(function (t, e) {
  ...
  function o(e) {
    (this.$element = t(e)),
      (this.original_text = t.trim(this.$element.html())),
      (this.settings = t.extend({}, t.fn.trunk8.defaults));
  }
  function l(t) {
    var e = document.createElement('DIV');
    return (
      (e.innerHTML = t), void 0 !== e.textContent ? e.textContent : e.innerText
    );
  }
  function u(e, n, r) {
    e = e.replace(r, '');
  ...
  function h() {
    ...
    if (
      ...
      for (e = 0, r = S - 1; e <= r; )
        (i = e + ((r - e) >> 1)),
          (a = n.eatStr(y, d, S - i, p)),
          m && h && (a = u(a, h, p)),
          this.html(a),
          this.height() > v
            ? (r = i - 1)
            : ((e = i + 1), (x = x.length > a.length ? x : a));
  ...
  (o.prototype.updateSettings = function (e) {
    ...
    (e = {
      ...
      update: function (e) {
        return this.each(function () {
          var n = t(this);
          e && (n.data('trunk8').original_text = e), h.call(n);
        });
      },
      revert: function () {
        return this.each(function () {
        ...
        switch (
          ...
          case r:
            return (
              ...
              (h = o >> 1),
              (n.eatStr.cache[f] =
                t.trim(n.eatStr(e.substr(0, c - u), a, o - h, '')) +
                l +
                t.trim(n.eatStr(e.substr(c - u), i, h, '')))
            );
          default:
    ...
    (t.fn.trunk8 = function (n) {
      return e[n]
        ...
        : 'object' != typeof n && n
        ? void t.error('Method ' + n + ' does not exist on jQuery.trunk8')
...
ajaxify = function (settings) {
  ...
  var endlessScrollContainer =
    settings.endlessScrollContainer || '.EndlessScroll'; // Selector for endless scroll pages
  ...
  var sectionId =
    $(endlessScrollContainer).closest('[data-section-id]').data('section-id') ||
  ...
  $.endlessScroll = function () {
    ...
    $(window).on(action, function () {
      ...
      if ($(contentContainer + ':last-of-type ' + linkElem).length) {
        ...
        var docTop =
          $(document).scrollTop() + $(window).height() + endlessOffset;
        if (docTop > bottom) {
          $(window).off(action);
          $.loadMore();
        }
...
jQuery(function ($) {
  var Sections = {
    ...
    _onSectionLoad: function (e) {
      var section =
        $(e.target).children('[data-section-type]').data('section-type') ||
        false;
      ...
      function _loadGallery(t) {
        ...
        options = $.extend({}, options, {
          ...
          prevArrow:
            ...
            window.theme.translations.previous +
            '" type="button">' +
            window.theme.icons.arrowSlider +
            '</button>',
          nextArrow:
            '<button class="slick-next slick-arrow" aria-label="' +
            window.theme.translations.next +
            '" type="button">' +
            window.theme.icons.arrowSlider +
            '</button>',
        });
      ...
      function _loadHero(t) {
        ...
        hero.on(
          ...
          function (event, slick, currentSlide, nextSlide) {
            ...
            var $nextSlide = $(this).find(
              '.js-slide[data-slick-index="' + activeSlide + '"]'
            );
        ...
        $(window).on(
          'scroll.slideshow resize.slideshow',
          Reqs.throttle(function () {
            ...
            if (
              heroOffsetTop + heroHeight >= windowScroll &&
              heroOffsetTop - windowHeight <= windowScroll &&
              autoplay
            ) {
        ...
        scrollDownBtn.on('click', function (e) {
          e.preventDefault();
          var headerHeight = 59;
          var scrollToPosition = parseInt(
            hero.offset().top + hero.outerHeight() - headerHeight
          );
          $('html, body')
            .stop(true, false)
    ...
    _onSectionUnload: function (e) {
      var section =
        e.target.children[0].getAttribute('data-section-type') || false;
    ...
    _onSectionSelect: function (e) {
      var section =
        e.target.children[0].getAttribute('data-section-type') ||
        e.target.children[1].getAttribute('data-section-type') ||
        e.target.children[2].getAttribute('data-section-type') ||
        false;
  ...
  window.Site = {
    ...
    header: {
      init: function () {
        ...
        $(window)
          ...
          .on(
            'resize' + namespace,
            Reqs.throttle(Site.setCartClosePosition, 50)
          )
          .on(
            'resize' + namespace,
            Reqs.debounce(function () {
        ...
        function getNavigationOverlapping() {
          ...
          var isNavCentered =
            $header.hasClass('header--logo_center_links_center') ||
            $header.hasClass('header--logo_left_links_center');
          var isNavLeftLogoCentered =
            $header.hasClass('header--logo_center_links_left') ||
            $header.hasClass('header--logo_left_links_left');
          ...
          if (isNavCentered) {
            logoWidth =
              logoWidth < headerIconsWidth ? headerIconsWidth : logoWidth;
            logoWidth = logoWidth * 2;
            headerIconsWidth = 0;
          }

          isNavigationOverlapping =
            parseInt(headerContainerWidth) <
            parseInt(
              navMenuWidth + logoWidth + headerIconsWidth + additionalSpace
            );

          if (isNavLeftLogoCentered) {
            isNavigationOverlapping =
              parseInt((headerContainerWidth - logoWidth) / 2) <
              parseInt(navMenuWidth);
          }
      ...
      resetHeader: function () {
        var $body = $('body'),
          ...
          $transformElements = $(
            '.site-header, .siteAlert, .bodyWrap, .shop-bar'
          ),
    ...
    sliders: {
      ...
      collection: function () {
        ...
        function setQuickViewPosition() {
          ...
          if ($carousel.length && $slide.length) {
            ...
            var offsetLeft =
              $carousel.find('.slick-slide.slick-current').position().left -
              $slide.position().left;
      ...
      setCarouselState: function ($container) {
        ...
        function initCarousel() {
          if (!isDesktopInitialized) {
            ...
            $carousel.slick(options).on('beforeChange', function () {
        ...
        function setArrowsPosition() {
          ...
          var arrowTop =
            $carousel.find('.collectionBlock-image').outerHeight() / 2;
      ...
      gallery: function () {
        ...
        slider.each(function () {
          var currentSlider = $(this),
            ...
            options = JSON.parse(
              currentSlider.data('slick').replace(/'/g, '"')
            );
          ...
          $(window)
            .on(
              'scroll.gallery',
              Reqs.debounce(function () {
                var isSliderVisible = isAnyPartOfElementInViewport(
                  currentSlider.get(0)
                );
      ...
      truncateMosaicText: function (container) {
        $(container)
          .find('.mosaic__heading, .mosaic__subheading')
          .trunk8({ lines: 1 });
    ...
    nav: {
      ...
      bindings: function () {
        ...
        $body.on('keyup', function (e) {
          ...
          var $focusedElement = $(e.target),
            ...
            isSearchChild =
              $focusedElement.parents('.nav-search').length ||
              !$focusedElement.is('.js-searchToggle--open');
        ...
        $('.nav-hamburger .has-submenu .dropdown-arrow').on(
          'click',
          function (e) {
        ...
        $body.on('click', function (e) {
          if (
            !$(e.target).is('.js-menuToggle, .js-menuToggle *, .nav-main *')
          ) {
            Site.nav.hide();
          }
        });
      ...
      show: function () {
        ...
        $transformElements.css({
          transform: 'translateX(' + navMenuWidth + ')',
        });

        $(window).on(
          'resize.siteNav',
          Reqs.debounce(function () {
            var isHamburger = $('.site-header').hasClass(
              'header--is-hamburger'
            );
            if (isHamburger) {
    ...
    checkReviewsApp: function () {
      ...
      var checkingApp = setInterval(function () {
        var reviewsAppInstalled =
          (typeof window.SPR == 'function' && showReviews) ||
          (typeof yotpo == 'object' && showYotpo && yotpoID);
    ...
    animations: {
      init: function () {
        var self = this,
          ...
          enableGridItemsAnimations =
            window.theme.settings.enableGridItemsAnimations;
...
Cart = {
        ...
        $.ajax({
          ...
          success: function (product) {
            var variants = product.variants,
              ...
              error_details =
                window.theme.translations.form_submit_error_details, // translation string
  ...
  popover: {
    show: function (product) {
      ...
      if (product.unit_price_measurement) {
        unitPrice =
          slate.Currency.formatMoney(product.unit_price, window.moneyFormat) +
          ' ';
  ...
  buildCart: function (cart) {
    ...
    if (cart.item_count === 0) {
      $cart.append(
        '<div class="cart-title cart-title--empty">\
							<h2>' +
          window.theme.translations.cart_title +
          '</h2>\
							<p>' +
          window.theme.translations.cart_empty +
          '</p>\
							<a tabindex="-1" class="js-continueShopping js-continueShopping--empty js-go-back button">' +
          window.theme.translations.continue_shopping +
          '</a>\
						</div>'
      );
    ...
    $.each(cart.items, function (index, cartItem) {
      ...
      productPrice +=
        '<span>' +
        slate.Currency.formatMoney(cartItem.final_price, window.moneyFormat) +
        '</span>';
      ...
      productTotalPrice += slate.Currency.formatMoney(
      ...
      if (discountsArray.length) {
        ...
        for (var j = 0; j < discountsArray.length; j++) {
          discounts +=
            '<p>' +
            discountsArray[j].title +
            ' (-' +
            slate.Currency.formatMoney(
              discountsArray[j].amount,
              window.moneyFormat
            ) +
            ')</p>';
        }
      ...
      if (cartItem.unit_price_measurement) {
        unitPrice =
          slate.Currency.formatMoney(cartItem.unit_price, window.moneyFormat) +
          ' ';
        unitPrice +=
          '<span aria-hidden="true">/</span><span class="visually-hidden">' +
          window.theme.translations.unit_price_separator +
          '</span>&nbsp;';
    ...
    if (cartDiscounts.length) {
      ...
      for (var j = 0; j < cartDiscounts.length; j++) {
        ...
        totalDiscounts +=
          '<span>-' +
          slate.Currency.formatMoney(
            cartDiscounts[j].total_allocated_amount,
            window.moneyFormat
          ) +
          '</span>';
      }
  ...
  initTermsAcceptance: function () {
    ...
    if ($(selectors.cartAcceptance).length) {
      var cartFormErrorElement =
          '<div class="errors" data-cart-error>' +
          window.theme.translations.cart_acceptance_error +
          '</div>',
      ...
      $(selectors.cartContainer)
        ...
        .on(
          'submit' + namespace,
          selectors.cartFormDynamicCheckout,
          formSubmitFunction
        )
...
var Collection = {
  ...
  init: function () {
    ...
    $(this.selectors.collectionProducts).each(function () {
      ...
      if (window.theme.settings.imageBackgroundSize == 'contain') {
        ...
        $(window).on(
          'resize.' + sectionId,
          Reqs.debounce(self.setBadgePosition.bind(self, $image), 50)
        );
      }
    ...
    $(window).on(
      'resize.collection',
      Reqs.throttle(self.truncateFeaturedImageText.bind(self), 50)
    );
  },
  ...
  ajaxSort: function (url) {
    ...
    $.ajax({
      ...
      url: url,
      success: function (data) {
        var products = $(data).find(self.selectors.collectionProducts)[0]
          .outerHTML;
        var nextPage = $(data)
          .find(self.selectors.collectionProducts)
          .next('.row')[0]
          ? $(data).find(self.selectors.collectionProducts).next('.row')[0]
              .outerHTML
          : '';
  ...
  ajaxLoadMore: function (url) {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $(self.selectors.collectionProducts)
          .find(self.selectors.gridSpacer)
          .remove();
        ...
        if (typeof nextPage !== 'undefined') {
          $(self.selectors.loadMoreButton)
            .attr('href', nextPage)
            .removeClass(self.classes.loading);
        } else {
  ...
  initFilters: function (container) {
    ...
    /* Bind toggle buttons */
    $collectionFilters.on(
      'click',
      this.selectors.collectionFilterTitle,
      function () {
        var windowWidth =
            window.innerWidth ||
            document.documentElement.clientWidth ||
            document.body.clientWidth,
          isTopPosition =
            windowWidth < 1280 || $('.collection__filters--top').length,
          isAriaExpanded = !(
            $(this).parent().hasClass(self.classes.isExpanded) ||
            $(this)
              .parent()
              .hasClass(self.classes.collectionFilterAccordionExpanded)
          );
        ...
        if (isTopPosition) {
          ...
          if (
            $collectionFilters.find('.collection__filter.is-expanded').length
          ) {
    ...
    $collectionFilters.on(
      'click',
      this.selectors.collectionFilterTagButton,
      function (e) {
        ...
        var requestedURL =
          collection + '/' + self.tags.join('+') + '?sort_by=' + sort;
  ...
  requestFilteredProducts: function (instance, container, requestedURL) {
    var self = instance,
      $container = $(container),
      sectionId = $(container).data('section-id'),
      productsTop = parseInt(
        Math.ceil($(self.selectors.collectionWrapper).offset().top) - 60
      ), // Add 60px to give space for the header
      action =
        'scroll.endlessScroll--' +
        sectionId +
        ' resize.endlessScroll--' +
        sectionId;
    ...
    if (!self.tags.length) {
      $(self.selectors.collectionFiltersResetButton)
        .removeClass(self.classes.isVisible)
        .slideUp(300);
      $(self.selectors.collectionFilters).removeClass(
        self.classes.collectionFiltersHasTagsSelected
      );
    }
    ...
    self.filterProductsRequest = $.ajax({
      ...
      .done(function (data) {
        var collectionProducts = $(data)
            .find(self.selectors.collectionProducts)
            .html(),
          productsFoundLabel = $(data)
            .find(self.selectors.productsFoundLabel)
            .html(),
        ...
        if ($pagination.length) {
          $(self.selectors.collectionPagination, container).html(
            $pagination.html()
          );
        } else {
        ...
        if (window.theme.settings.imageBackgroundSize == 'contain') {
          ...
          $(window)
            ...
            .on(
              'resize.products',
              Reqs.debounce(Collection.setBadgePosition.bind(this, $image), 50)
            );
        }
        ...
        if (self.tags.length) {
          ...
          $(self.selectors.collectionFilters).addClass(
            self.classes.collectionFiltersHasTagsSelected
          );
        }
        ...
        setTimeout(function () {
          $(self.selectors.collectionWrapper).removeClass(
            self.classes.isLoading
          );
        }, 450);
  ...
  checkFiltersPosition: function () {
    var isFiltersPositionTop = $(this.selectors.collectionFilters).hasClass(
        this.classes.collectionFiltersTop
      ),
      windowWidth = window.innerWidth || document.documentElement.clientWidth,
      containerWidth = $(this.selectors.collectionFilters)
        .children()
        .first()
        .width(),
    ...
    if (isFiltersPositionTop || windowWidth < 1280) {
      ...
      isOverlapping =
        containerWidth - collectionFiltersWidth - spaceBetween <
        resetButtonWidth;
  ...
  bindResetButton: function (container) {
    ...
    $(this.selectors.collectionFiltersResetButton).on('click', function (e) {
      $collectionFilters
        ...
        .removeClass(self.classes.isExpanded);
      $collectionFilters
        .find(self.selectors.collectionFilterTag)
        .removeClass(self.classes.isActive);
      $collectionFilters.removeClass(self.classes.hasTagsExpanded);
...
var ListCollections = {
  ...
  init: function () {
    ...
    $(this.selectors.listCollectionsContainer).each(function () {
      ...
      $(window).on(
        'resize.' + sectionId,
        Reqs.throttle(self.truncateBlockText.bind(self, $container), 50)
      );
  ...
  truncateBlockText: function ($collectionList) {
    var fourPerRow = $collectionList
        .find(this.selectors.collectionBlock)
        .hasClass(this.classes.gridLargeOneQuarter),
    ...
    $(this.selectors.collectionBlock, $collectionList).removeClass(
      this.classes.isLoading
    );
  },
};
...
var QuickView = {
  ...
  init: function () {
    ...
    $(document).on('click', this.selectors.quickViewButton, function (e) {
      var $selector = $(this),
        ...
        url = $(this).attr('href'),
        sectionId = $selector
          .closest(self.selectors.section)
          .data('section-id');
      ...
      if (!isQuickViewLoading) {
        ...
        // if loaded but not visible, no other quickViews open
          ...
          !el.hasClass('quickView--is-visible') &&
  ...
  show: function (el) {
    ...
    $('html, body')
      .stop(true, true)
      .animate({ scrollTop: scrollPosition }, 300, function () {
        Site.initReviews();
  ...
  ajaxSearch: function (el, url, sectionId) {
    ...
    $.ajax({
      ...
      var productSectionId = 'product-template',
        productJSON = $(data)
          .find('#ProductJson--' + productSectionId)
          .text(),
        productMediaJson = $(data)
          .find('#ModelJson-' + productSectionId)
          .html(),
        product = JSON.parse(productJSON),
        productMediaSlider = self.modifyProductMediaSettings(
          $(data).find(self.selectors.productMediaSlider),
          self.settings
        ),
        productMediaThumbs = $(data)
          .find(self.selectors.productMediaThumbs)
          .html(),
        productTitle = self.addProductTitleLink(
          $(data).find(self.selectors.productTitle),
          url
        ),
        productForm = self.modifyProductFormIds(
          $(data).find(self.selectors.productForm),
          product.id
        ),
        productDescription = showProductDescription
          ? $(data).find(self.selectors.productDescription).html()
          : '',
        isProductMediaSingle =
          $(data).find('.js-productImgContainer > .js-slide').length == 1,
        item = {},
  ...
  initProductMediaSlider: function (container) {
    var self = this,
      ...
      isDraggable = !(
        $productImgSlider.find('.product-single__media--video').length ||
        $productImgSlider.find('.product-single__media--model').length
      ),
    ...
    if ($productImgSlider.find('.js-slide').length > 1) {
      $productImgSlider
        ...
        .on('change.flickity', function (event, index) {
          var $currentSlide = $productImgSlider.find('.js-slide').eq(index),
            $currentSlideImage = $currentSlide.find(
      ...
      function initSliderNav() {
        var isInitialized = $productImgSliderNav.data('flickity'),
          sliderNavArrows =
            Site.sliders.checkThumbnailsOverflow($productImgSliderNav);
  ...
  handleMediaFocus: function (e) {
    ...
    flickNav = $(this.selectors.productMediaThumbs, $container).data(
      'flickity'
    );
  ...
  switchMedia: function (container, mediaId) {
    var $container = $(container),
      $currentMedia = $(
        this.selectors.productMediaWrapper + ':not(.media--hidden)',
        $container
      ),
      $newMedia = $(
        this.selectors.productMediaWrapper +
  ...
  initShopifyXrLaunch: function (container) {
    ...
    $(document).on('shopify_xr_launch', function () {
      var $currentMedia = $(
        self.selectors.productMediaWrapper + ':not(.media--hidden)',
        container
      );
  ...
  initVariants: function (container, product) {
    ...
    $container.on(
      'variantPriceChange' + namespace,
      this.updateProductPrices.bind(this)
    );
    $container.on(
      'variantUnitChange' + namespace,
      this.updateProductUnits.bind(this)
    );
    $container.on(
      'variantImageChange' + namespace,
    ...
    if (variant) {
      if (variant.available) {
        ...
        $(this.selectors.addToCartText, this.$container).html(
          window.theme.translations.add_to_cart
        );
        ...
        $(this.selectors.addToCartText, this.$container).html(
          window.theme.translations.sold_out
        );
  ...
  updateColorName: function (evt) {
    var colorName = $(this.selectors.colorSwatch, this.$container)
      .filter(':checked')
      .val();
  ...
  updateProductPrices: function (evt) {
    ...
    $productPrice.html(
      slate.Currency.formatMoney(variant.price, window.moneyFormat)
    );
    ...
    if (variant.compare_at_price > variant.price) {
      ...
      $comparePrice.html('').addClass('visually-hidden');
    }
  },
  ...
  updateProductUnits: function (evt) {
    ...
    if (typeof variant.unit_price !== 'undefined') {
      var price = slate.Currency.formatMoney(
          variant.unit_price,
          window.moneyFormat
        ),
    ...
    productMediaSlider.find('.product-image').each(function () {
      $(this)
        .attr(
          ...
          window.theme.settings.enableVideoLooping
        )
  ...
  addProductTitleLink: function (productTitle, url) {
    ...
    productTitle
      .find('.product-title')
      .html('<a href="' + url + '">' + productTitleText + '</a>');
...
var Product = {
  ...
  init: function (update, sectionId) {
    ...
    if (update) {
      ...
      var productSections = document.querySelectorAll(
  ...
  initSingleProduct: function (container, update) {
    var self = this,
      ...
      isLayoutScrollable = $(
        this.selectors.productLayoutScrollable,
        container
      ).length,
    ...
    if (!isOnboarding) {
      ...
      $(this.selectors.colorSwatch, container).on('change', function () {
        var colorName = $(self.selectors.colorSwatch, container)
          .filter(':checked')
          .val();
  ...
  updateAddToCartState: function (evt) {
    ...
    if (variant) {
      if (variant.available) {
        ...
        $(this.selectors.addToCartText, container).html(
          window.theme.translations.add_to_cart
        );
        $(this.selectors.notificationForm, container).addClass(
          'visually-hidden'
        );
      } else {
        ...
        $(this.selectors.notificationForm, container).removeClass(
          'visually-hidden'
        );
      }
    } else {
    ...
    if ($shopBar.length) {
      if (variant) {
        if (variant.available) {
          ...
          $(this.selectors.addToCartText, $shopBar).html(
            window.theme.translations.add_to_cart
          );
        } else {
  ...
  updateColorName: function (evt) {
    var container = evt.target;
    var colorName = $(this.selectors.colorSwatch, container)
      .filter(':checked')
      .val();
  ...
  updateProductPrices: function (evt) {
    var container = evt.target,
      variant = evt.variant,
      $comparePrice = $(this.selectors.comparePrice, container).add(
        $(this.selectors.comparePrice, this.selectors.shopBar)
      ),
      $productPrice = $(this.selectors.productPrice, container).add(
        $(this.selectors.productPrice, this.selectors.shopBar)
      );
  ...
  initProductMediaSlider: function (container) {
    var self = this,
      ...
      isDraggable = !(
        $(this.selectors.productMediaVideo, $productImgSlider).length ||
        $(this.selectors.productMediaModel, $productImgSlider).length
      ),
      activeSlide = $(
        this.selectors.productSelected,
        $productImgSlider
      ).index(),
    ...
    if (hasSlides) {
      $productImgSlider
        .on('ready.flickity', function () {
          $productImgSlider.attr('tabindex', '-1');
          $(self.selectors.productSlide, $productImgSlider).attr(
            'tabindex',
            '-1'
          );
        })
        .on('change.flickity', function (event, index) {
          var $currentSlide = $(
              self.selectors.productSlide,
              $productImgSlider
            ).eq(index),
            $currentSlideImage = $(
              self.selectors.productMediaImage,
              $currentSlide
            );
  ...
  initImageGallery: function (container) {
    var self = this,
      $productImgContainer = $(
        self.selectors.productSliderContainer,
        container
      ),
    ...
    $(
      self.selectors.productImageLightboxLink,
      $productImgContainer
    ).magnificPopup({
  ...
  initProductTabs: function (container) {
    ...
    enquire.register('screen and (min-width: 768px)', function () {
      ...
      $(self.selectors.productTabTitle, $productTabs)
        .remove()
        .appendTo(tabsTitles);
      $(self.selectors.productTabContent, $productTabs)
        .remove()
    ...
    $productTabs.on('click', self.selectors.productTabTitle, function () {
      ...
      $productTabs
        .find(self.selectors.productTabTitle)
        .removeClass('is-active');
      $productTabs
        .find(self.selectors.productTabContent)
        .removeClass('is-active');
      ...
      if (isActive) {
        ...
        if (
          !$productTabs.find(self.selectors.productTabTitle).eq(tabIndex).length
        ) {
          tabIndex = 0;
        }
        ...
        if (windowWidth >= 768) {
          ...
          if ($(this).next().next(self.selectors.productTabTitle).length) {
            ...
            $(this)
              .next()
              .next(self.selectors.productTabTitle)
              .addClass('is-active')
              .next(self.selectors.productTabContent)
              .addClass('is-active');
          } else {
            if (tabsCount == 1) {
      ...
      if (
        windowWidth < 768 &&
        $productTabs.find(self.selectors.productTabTitle + '.is-active').length
      ) {
        setTimeout(function () {
          var activeTabPosition =
            $productTabs
              .find(self.selectors.productTabTitle + '.is-active')
              .offset().top - 61; // 60px header height + 1px border top width
          $('html, body')
            .stop(true, true)
            .animate({ scrollTop: activeTabPosition });
        }, 300);
      }
    });
  },
    ...
    if (productImages > 1) {
      ...
      $productImgNav.on('click', this.selectors.productThumbnail, function (e) {
        ...
        if (windowWidth >= 768) {
          var id = $(this).parent().data('id'),
            $selectedImage = $(
              self.selectors.productMediaWrapper + '[data-id="' + id + '"]'
            ),
            headerHeight = 59,
            additionalSpace = 40;
      ...
      function toggleMobileSlider() {
        var windowWidth =
            ...
            document.body.clientWidth,
          hasSlides =
            $(self.selectors.productSlide, $productLayoutScrollable).length > 1;
        ...
        if (windowWidth >= 768) {
          ...
          for (var i = $productImg.length - 1; i >= 0; i--) {
            ...
            if (scrolled >= productOffset) {
              $productImgNav
                .find(
                  self.selectors.productMediaThumb + '[data-id="' + id + '"]'
                )
                .addClass('active')
                .siblings()
                .removeClass('active');
    ...
    function initMobileSlider() {
      var $productImgSlider = $(self.selectors.productScroller, container),
        ...
        sliderNavArrows =
          Site.sliders.checkThumbnailsOverflow($productImgSliderNav),
        isDraggable = !(
          $(self.selectors.productMediaVideo, $productImgSlider).length ||
          $(self.selectors.productMediaModel, $productImgSlider).length
        ),
        activeSlide = $(
          self.selectors.productSelected,
          $productImgSlider
        ).index();
  ...
  handleMediaFocus: function (e, container) {
    ...
    var mediaId = $(e.currentTarget).data('thumbnail-id'),
      slideIndex = $(
        this.selectors.productSlide + '[data-media-id="' + mediaId + '"]',
        container
      ).index(),
      flick = $(this.selectors.productSliderContainer, container).data(
        'flickity'
      ),
  ...
  initShopBar: function (container) {
    ...
    $shopBar.on('change', 'select', function (e) {
      var optionSelected = $(this).val(),
        ...
        $singleOptionSelector = $(
          self.selectors.singleOptionSelector,
          container
        ),
        $formElement = $singleOptionSelector.filter(
    ...
    // Update shop bar on product form variant change
    $(this.selectors.singleOptionSelector, container).on(
      'change',
      function (e) {
  ...
  showVariantImage: function (variant, container) {
    var variantMediaId = variant.featured_media
    ...
    if (flick && flick.isActive) {
      ...
      var $variantThumb = $imgScrollerNav.find(
        '[data-id="' + variantMediaId + '"] .js-product-single__thumbnail'
      );
...
var RelatedProducts = {
  init: function () {
    ...
    $.get(requestUrl).done(function (data) {
      var products = $(data)
        .find('[data-section-type="related-products"]')
        .html();
...
var Blog = {
  ...
  init: function () {
    ...
    $(window)
      ...
      .on(
        'resize' + namespace,
        Reqs.debounce(self.truncateText.bind(self), 250)
      )
      .on(
        'resize' + namespace,
        Reqs.debounce(self.removeAnimations.bind(self), 250)
      );
...
var Gmap = {
  ...
  geolocate: function ($map) {
    var deferred = $.Deferred(),
      ...
      address =
        $map.closest(this.selectors.map).data('address') || defaultAddress;
  ...
  createMap: function (container) {
    ...
    return instance.geolocate($map).then(
      function (results) {
        var mapOptions = {
          styles: styles,
    ...
    if (popupEnabled) {
      ...
      enquire.register('screen and (min-width:768px)', function () {
        ...
        if (testMode) {
          ...
          if (
            Cookies.get('newsletter_delay') === undefined ||
            reappearTime == 0
          ) {
            self.show($popup, modalDelay, testMode);
...
var Search = {
  ...
  getResultsContent: function (data) {
    ...
    if (data.results) {
      for (var i = 0; i < data.results.length; i++) {
        var title = data.results[i].title,
          ...
          badgeText = '',
          badgeClass =
            ' product-status-flag--' + window.theme.settings.productBadgeStyle,
    ...
    searchResultsProducts = countProducts
      ? searchResultsProducts
      : '<li class="result__item"><p class="result__title">' +
        window.theme.translations.no_results +
        '</p></li>';
    searchResultsPages = countPages
      ? searchResultsPages
      : '<li class="result__item"><p class="result__title">' +
        window.theme.translations.no_results +
        '</p></li>';
    searchResultsArticles = countArticles
      ? searchResultsArticles
      : '<li class="result__item"><p class="result__title">' +
        window.theme.translations.no_results +
        '</p></li>';
    ...
    viewAllProducts = countProducts
      ? '<a href="' +
        window.theme.routes.search_url +
        '?type=product&q=' +
        searchQuery +
        '&options[prefix]=' +
        searchOptionsPrefix +
        '" class="view-all" title="' +
        window.theme.translations.view_all +
        '">' +
        window.theme.icons.arrowLong +
        '</a>'
      : '';
    ...
    searchResults +=
      ...
      '<span>' +
      window.theme.translations.results_products +
      ' (' +
      countProducts +
      ')</span>' +
      viewAllProducts +
    ...
    if (searchType.indexOf('page') > -1) {
      searchResults +=
        ...
        '<div class="results__heading">' +
        '<span>' +
        window.theme.translations.results_pages +
        ' (' +
        countPages +
        ')</span>' +
        '</div>' +
    ...
    if (searchType.indexOf('article') > -1) {
      searchResults +=
        ...
        '<div class="results__heading">' +
        '<span>' +
        window.theme.translations.results_articles +
        ' (' +
        countArticles +
        ')</span>' +
        '</div>' +
    ...
    Shopify.CustomerAddress = {
      ...
      toggleNewForm: function () {
        ...
        toggle.style.display =
          toggle.style.display == 'inline-block' ? 'none' : 'inline-block';
        return false;
      },
      ...
      destroy: function (id, confirm_msg) {
        if (
          confirm(
            confirm_msg || 'Are you sure you wish to delete this address?'
          )
        ) {
    ...
    _fetchStoreAvailabilities: function (
      ...
      fetch(variantSectionUrl)
        ...
        .then(function (storeAvailabilityHTML) {
          ...
          var storeAvailabilityModal = body.querySelector(
            selectors.storeAvailabilityModal
          );
          ...
          var storeAvailabilityModal = self.container.querySelector(
            selectors.storeAvailabilityModal
          );
...
theme.Modals = (function () {
  ...
  Modal.prototype.open = function (evt) {
    ...
    var scrollableElement = document.querySelector(
